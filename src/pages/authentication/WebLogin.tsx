...
export default function LoginPage() {
  ...
  return (
    <div className="relative flex min-h-screen items-center justify-center bg-gray-50 dark:bg-gray-900 overflow-hidden">
      ...
      >
        {/* <img src="/Login.png" alt="cover" className="object-fit" /> */}
        {/* Login Card */}
                    ...
                    >
                      ...
                      <div className="relative">
                        ...
                        <button
                          ...
                          className="absolute right-3 top-1/2 -translate-y-3/3 text-gray-500 hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-200"
                        >
                          {!showPassword ? (
